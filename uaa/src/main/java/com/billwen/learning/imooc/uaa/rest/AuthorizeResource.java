...
import com.billwen.learning.imooc.uaa.domain.dto.LoginDto;
import com.billwen.learning.imooc.uaa.domain.dto.SendTotpDto;
import com.billwen.learning.imooc.uaa.domain.dto.UserDto;
import com.billwen.learning.imooc.uaa.domain.dto.VerifyTotpDto;
import com.billwen.learning.imooc.uaa.exception.DuplicateProblem;
import com.billwen.learning.imooc.uaa.service.UserCacheService;
...
import static com.billwen.learning.imooc.uaa.domain.MfaType.SMS;
...
public class AuthorizeResource {
    ...
    public Auth verifyTotp(@Valid @RequestBody VerifyTotpDto verifyTotpDto) {
        return userCacheService.verifyTotp(verifyTotpDto.getMfaId(), verifyTotpDto.getCode())
            ...
            .orElseThrow(() -> new BadCredentialsException("Code is invalid"));
    }
